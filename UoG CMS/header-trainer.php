...
<html lang="en">
    ...
    <body>
        <header>
            <nav>
                <div class="row">
                    <img src="resources/img/cms.png"  class="logo">
                    <img src="resources/img/cms.png"  class="logo-black">
                    <ul class="main-nav js--main-nav">
                        <li><a href="./App_load/add_trainee.php">Add Trainee</a></li>
                        <li><a href="./App_load/manage_course.php">Manage course</a></li>
                        <li><a href="./App_load/manage_trainee.php">Manage trainee</a></li>
                        <li><a href="#plans">Log out</a></li>
                    </ul>
